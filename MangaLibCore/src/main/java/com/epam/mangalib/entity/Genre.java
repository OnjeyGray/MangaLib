...
public class Genre extends SQLObject {
    private List<Manga> mangaList;

    public Genre() {}

    public Genre(Map<String, Object> objectMap) {
        super(objectMap);
    }

    public long getId() {
        return (long) get(GENRE_ID);
    }
    ...
    public String getDescription() {
        return (String) get(GENRE_DESCRIPTION);
    }

    public void setDescription(String description) {
        set(GENRE_DESCRIPTION, description);
    }
