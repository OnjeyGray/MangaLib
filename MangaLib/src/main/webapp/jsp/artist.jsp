    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-8 col-xl-9">
            <div class="d-flex auto-x">
                <c:forEach items="${artist.mangaList}" var="manga">
            ...
            <custom:checkAcces currentRole="${authorizedUser.role}" accessRole="ADMIN">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/controller/editArtist?attribute=artistName&artistId=${artist.id}" method="post" class="row">
                        ...
                        <form action="/controller/editArtist?attribute=artistDescription&artistId=${artist.id}" method="post" class="row">
                            <div class="form-group input-group col-8">
                                <textarea required pattern="^[^<>]{1,1000}$" name="artistDescription"
                        ...
                        <div class="mt-4">
                            <a href="/controller/editArtist?attribute=artist&action=delete&artistId=${artist.id}" class="btn btn-danger btn-block">
